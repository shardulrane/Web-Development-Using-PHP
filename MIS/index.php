    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="page-wrapper-cls" style="min-height:600px!important"  >
            <div id="page-inner" style="min-height:600px!important">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Login And Sign-Up :</h1>
                    </div>
                </div>
                <div class="row">
                <div class="col-md-6">
                   <form name="form1" method="post" action="checklogin1.php">
                     ...
                     <label>Enter Login ID : </label>
                        ...
                        <hr>
						&nbsp;
                        <input type="submit" name="Submit" value="Login" onclick="return ProcessForm()" class="btn btn-info">&nbsp;
						<input type="reset" name="Reset" value="Clear" class="btn btn-default"><br>
						<a href="checkuser.php">New User? Registered here...</a>
						</form>
                </div>
                <div class="col-md-6">
