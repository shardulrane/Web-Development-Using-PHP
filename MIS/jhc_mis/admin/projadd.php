...
function ProcessForm()
			{
				if(document.tstest.dept.value=="")
				{
					alert("Please Enter Department/Room No");
					document.tstest.dept.focus();
					return false;
				}

				if(document.tstest.loc.value=="0")
				{
					alert("Please Select Location");
					document.tstest.loc.focus();
					return false;
				}
				
				if(document.tstest.comp.value=="")
				{
					alert("Please Enter Company Details");
					document.tstest.comp.focus();
					return false;
				}
...
<body class="set-body">
    ...
    <div id="side-menu-push">
        <div class="link-main-site">
            <hr />
            <a href="http://www.jaihindcollege.com/" target="_blank" class="btn btn-default btn-lg">Go To Website</a>
            <hr />
        </div>
            ...
            <div id="page-inner" style="min-height:600px!important">
                <div class="row">
                    <div class="col-md-12"><br>
                        <h2 class="page-head-line"><center>Projector Entry Details</center></h2>
                    </div>
                </div>
                <div class="row">
				<form name="tstest"  method="post" action="projinput.php">
				<table width="100%" class="table table-striped table-bordered table-hover">
				<tr>
				<td>
				<label>Department/Room No</label></td><td>
				<input type="Text" name="dept" class="form-control"></td><td>
				<label>Location</label></td><td>
				<select name="loc" class="form-control">
<option value="0">Select Location
<option value="Gnd_Floor">Gnd_Floor
<option value="1st_Floor">1st_Floor
<option value="2nd_Floor">2nd_Floor
<option value="3rd_Floor">3rd_Floor
<option value="4th_Floor">4th_Floor
<option value="5th_Floor">5th_Floor</select></td></tr><tr>
<td>
				<label>Company</label></td><td>
				<input type="Text" name="comp" class="form-control"></td><td>
				<label>Model No</label></td><td>
				<input type="Text" name="mod" class="form-control"></td></tr><tr>
				<td>
				<label>Serial No</label></td><td>
				<input type="Text" name="ser" class="form-control"></td></tr>
				<tr>
