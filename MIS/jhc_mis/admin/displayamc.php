...
<tr><th><label>Receiving Date & Time</label></th>
...
<a href="javascript:show_calendar('document.tstest.t2', document.tstest.t2.value);"><img src="cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the timestamp"></a>
	    ...
	    <td colspan='2'>&nbsp;&nbsp;&nbsp;&nbsp;
	    <input type = "Submit" class="btn btn-primary" name = "update" value = "Update" onclick="return ProcessForm()" style="width: 120px; height: 40px">
    </td>    </tr>
</table><!-- SCRIPTS -AT THE BOTOM TO REDUCE THE LOAD TIME-->
    <!-- JQUERY SCRIPTS -->
