...
<script type="text/javascript">
    ...
    if (str == "") {
        ...
        xmlhttp.open('GET','lecturesql1.php?q='+str,true);
        xmlhttp.send();
    }
} 
...
function showsem3(str) {
    ...
    if (str == "") {
        ...
        xmlhttp.open('GET','showsem3.php?q='+str,true);
        xmlhttp.send();
    }
}
...
<body class="set-body">
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<img src="images/jhclogo.gif" height="74" width="74">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<font style="High Tower Text" size=8>Managment Information System</font>
	...
	<li>
	 ...
	 <div id="page-wrapper" class="page-wrapper-cls">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Filter Class Registration Details</h1>
                    </div>
                </div>
                 <div >
...
<th>Class</th>
<td> <select name="class1" id="class1" class="form-control"  onchange="showsem3(this.value)">
...
$sql="SELECT distinct Class FROM class_reg order by Class asc";
...
<th>Semester</th>
<td> 
<select name="sem" id="sem" class="form-control" onchange="showUser1(this.value)">
...
<div id="txtHint"><b>Allotment Details will be listed here.</b></div>
