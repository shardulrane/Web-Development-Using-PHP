...
?>                         
            ...
            <div id="page-inner" style="min-height:600px!important">
                <div class="row">
                    <div class="col-md-12"><br>
                        <h2 class="page-head-line"><center>Department E-Notices</h1></center>
                    </div>
                </div>
	...
	<table class="table table-striped table-bordered table-hover" border="1">
				...
				<?php
					 /*  $b=$_SESSION["pid"];
					  $q="SELECT Dept_ID FROM login where name='$b' LIMIT 1";
	...
	while($row=mysql_fetch_array($result_set))
	{
		?>
		<tr>
				<td align='center'><a href="../Uploads/<?php echo $row['file'] ?>"  target="_blank"><?php echo $row['Title'] ?></a>
	</td>
	</tr>
		<?php
				}
