            ...
            <div id="page-inner" style="min-height:600px!important">
                <div class="row">
                    <div class="col-md-12"><br>
                        <h2 class="page-head-line"><center>Printer Entry Details</center></h2>
                    </div>
                </div>
                <div class="row">
				<form name="tstest" method="post" action="prninput.php">
...
<input type="Text" name="user" class="form-control"></td><td>
<label>JHC Identification No</label></td><td>
<input type="Text" name="idn" class="form-control"></td></tr>
<tr>
<td>
<label>Item</label></td><td>
<input type="Text" name="item" class="form-control"></td><td>
<label>Brand</label></td><td>
<input type="Text" name="brand" class="form-control"></td></tr><tr><td>
<label>Model_Type</label></td><td>
<input type="Text" name="mod" class="form-control"></td><td>
<label>Serial_No</label></td><td>
<input type="Text" name="ser" class="form-control"></td></tr>
<tr></tr>
<tr>
<td colspan='4' align="center">
<input type="submit" name="submit" value="Submit" class="btn btn-primary" onclick="return ProcessForm()">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
