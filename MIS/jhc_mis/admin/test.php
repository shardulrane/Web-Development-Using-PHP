...
xmlhttp.open("GET","getsw1.php?q="+str,true);
xmlhttp.send();
}
...
xmlhttp.open("GET","getsw.php?q="+str,true);
xmlhttp.send();
}
...
xmlhttp.open("GET","getsw2.php?q="+str,true);
xmlhttp.send();
}
</script>
</head>
...
?>
				...
				<li>
						<a href="#">Engineer<span class="fa arrow"></span></a>
			...
			<li><a href="#">Asset Log<span class="fa arrow"></span></a>
				...
				<li><a href="classreg.php">Class Allotment</a>
				</li>
				<li><a href="#">Lecture Report<span class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
					...
					<ul class="nav nav-second-level">
						...
						<li><a href="adminenotices.php">
						View E-Notices</a></li>
					</ul>
				</li> <li><a href="adminlogin.php">Back To Home</a></ul></li>
			</ul>            </ul>
            </div>
            ...
            <div id="page-inner" style="min-height:600px!important">
                <div class="row">
                    <div class="col-md-12"><br>
                        <h2 class="page-head-line"><center>Filter Switch Details</center></h2>
                    </div>
                </div>
                <div class="row">
...
<option value="0">Select By Item</option>
<option value="All">All</option>
<?php
//$q=$_GET["q"];
...
$sql="SELECT distinct Item FROM jhc_switch order by Item";
