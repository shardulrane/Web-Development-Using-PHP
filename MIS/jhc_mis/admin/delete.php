...
<div class="col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                               <center><h4>Select A Single E-Notice To Delete</h4></center><form action="deleteback.php" method="post">
                            </div>
...
while(false !== ($filename = readdir($dir_open)))
{
	...
	{
			$name=$filename;
			$trimname= rtrim($name,".pdf");
	echo "<tr>
			<th><b><font color='blue'>".$trimname."</b></font></th> <td><button class='btn btn-danger' type='radio' name='fileToDelete' id='fileToDelete' class='radio' value='$name'><i class='fa fa-pencil'></i> Delete</button></td>
</tr>
	";	
    }
}
	?>
            ...
            <!-- /. PAGE WRAPPER  --> <div class="col-md-6">
			<div class="alert alert-info">
                        InstructionsTo Delete E-Notice:
						<br>
                         <strong> NOTE :</strong>
                        <ul>
                            <li>
                        You Can Delete One Notice At A Time.
                        
                            </li>
                            <li>
                               After Selecting  The Notice Click The Delete Button At The Bottom
                            </li>
