...
if($q=="All")
{
	  ...
	  $sql=mysql_query("select * from jhc_projector");
}

else{ $sql=mysql_query("SELECT * FROM jhc_projector WHERE Department LIKE '$q%'");}


echo "<b>Projector AMC log for Department/Room No: $q </b>";
echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='projexcel_dept.php?q=$q'>
...
echo "<td>
<a href=\"displayproj.php?id=$row[Id]\" onclick=\"return confirm('Are you sure want to Update Id $row[Id]??');\">
