...
function showType(str) {
    if (str == "") {
        ...
        xmlhttp.open('GET','lecturetype.php?q='+str,true);
        xmlhttp.send();
    }
} 
function showName(str) {
    if (str == "") {
        ...
        xmlhttp.open('GET','lecturename.php?q='+str,true);
        xmlhttp.send();
    }
} 
function showsem1(str) {
    if (str == "") {
        ...
        xmlhttp.open('GET','showsem1.php?q='+str,true);
        xmlhttp.send();
    }
} 
function showsem2(str) {
    if (str == "") {
        ...
        xmlhttp.onreadystatechange = function() {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                document.getElementById('sem1').innerHTML = xmlhttp.responseText;
            }
        }
        xmlhttp.open('GET','showsem2.php?q='+str,true);
        xmlhttp.send();
    }
}
...
function showdateboth(str) {
    if (str == "") {
        ...
        xmlhttp.open('GET','lecturedate.php?q='+str,true);
        xmlhttp.send();
    }
}
function visiblity(){
	 document.tstest.sem.disabled=true;
}
</script>
...
<body class="set-body">
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<img src="images/jhclogo.gif" height="73" width="73">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<font font-family:"Calisto MT"; size=+4>Managment Information System</font>
...
?>                             
	...
	<li>
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Filter Lecture Report Details</h1>
                    </div>
                </div>
                 <div >
...
<tr><th>Name</th>
<td> <select name="class"  onchange="showsem1(this.value)" class="form-control">
...
$sql="SELECT * FROM Class_reg Group by Faculty Order By Faculty asc;";
...
<th>Semester</th>
<td> 
<select name="sem" id="sem" onchange="showName(this.value)" class="form-control">
<option value="0">Select Semester</option>



</tr>
<tr><th align="left">Search by Date</th>

<td colspan="5"><input type="text" readonly id="t1" name="inputField"style="width: 550px;" onclick='scwShow(this,this);' class="btn btn-default dropdown-toggle"/>
<input type="button" value="Submit" width="20%" onclick = "showUser2('lecturedate.php', 'txtHint')" class="btn btn-primary"> </td>
 
</tr>
<tr>
<th align="left">Select Date Range</th>


<th colspan="2">From Date
 <input type="text" id='t3' name="timestamp" readonly style="width: 250px;" onclick='scwShow(this,this);' class="btn btn-default dropdown-toggle">
</th>
<th colspan="3">To Date
<input type="Text" id='t2' name="timestamp0" readonly style="width: 350px;" onclick='scwShow(this,this);' class="btn btn-default dropdown-toggle">


     <input type = "button" value = "Click" onclick = "getData('lecturedateboth.php', 'txtHint')" class="btn btn-primary"> </th>
</tr>

</table>
</form>
<div id="txtHint"><b>Lecture Details will be listed here.</b></div>
