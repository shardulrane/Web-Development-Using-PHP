...
else{ $sql=mysql_query("SELECT * FROM jhc_desktop WHERE Department = '".$q."'");}

//<th>Date</th>
echo "<b>Desktop/Laptop log for Department: $q </b>";
echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href='deskexcel_dept.php?q=$q'>
...
<a href=\"deldesk.php?id=$row[Id]\" onclick=\"return confirm('Are you sure want to Delete $row[Username] with Id $row[Id]??');\">
