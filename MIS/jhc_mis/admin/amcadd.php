...
<td><input type="Text" name="dt"  class="btn btn-default dropdown-toggle" style="width: 200px;" readonly>
...
<td><input type="Text" id="rdt" name="rdt" class="btn btn-default dropdown-toggle" style="width: 200px;" readonly >
