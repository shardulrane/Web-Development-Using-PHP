...
<tr>
	    	  	<th>Serial No</th>
<td >
<input type="Text" name = "ser" class="form-control" style="width: 200px;" value="<?php echo $row['Serial_No']; ?>" >
</td>   
	
	    <td colspan='2'>&nbsp;&nbsp;&nbsp;&nbsp;
	    <input type = "Submit" name = "update" class="btn btn-primary btn-sm" value = "Update" onclick="return ProcessForm()" style="width: 100px; height: 30px">
    </td>       </tr>
