...
<li>
 ...
 <br>
			<marquee scrollamount="3" BGCOLOR=YELLOW  onmouseover="this.stop();" onmouseout="this.start();">	

		 <?php
					  $system_date=date("dMY");
	$sql="SELECT * FROM tbl_uploads where NType='University' ORDER BY date DESC LIMIT 2";
	$result_set=mysql_query($sql);
				...
				{
					?>
					<img src='new.gif' height='10'><a href="../Uploads/<?php echo $row['file'] ?>" style="color:red" target="_blank">
				...
				?>
				<?php
				$sql="SELECT * FROM tbl_uploads where NType='College' ORDER BY date DESC LIMIT 2";
	$result_set=mysql_query($sql);
	while($row=mysql_fetch_array($result_set))
	{
		?>
						<img src='new.gif' height='10'><a href="../Uploads/<?php echo $row['file'] ?>" style="color:red" target="_blank"><?php echo $row['Title'] ?></a>
		...
		<?php
				...
				<?php
					  //$b=$_SESSION["pid"];
					  //$q="SELECT Dept_ID FROM login where name='$b' LIMIT 2";
	...
	{
		?>
		<img src='new.gif' height='10'>
		<a href="../Uploads/<?php echo $row['file'] ?>" style="color:red" target="_blank"><?php echo $row['Title'] ?></a>
	...
	<div class="ws_images"><ul>
		<li><img src="../data0/images/b.jpg" alt="Wilson Sir At Xplore 2015" title="Wilson Sir At Xplore 2015" id="wows0_0"/></li>
		<li><img src="../data0/images/c.jpg" alt="Xplore 2015 Participants" title="Xplore 2015 Participants" id="wows0_1"/></li>
		<li><img src="../data0/images/d.jpg" alt="Lightening Of Lamp By Wilson Sir At Xplore 2015" title="Lightening Of Lamp By Wilson Sir At Xplore 2015" id="wows0_2"/></li>
		<li><img src="../data0/images/dsc_0020.jpg" alt="Sunita Mam At Xplore-2015" title="Sunita Mam At Xplore-2015" id="wows0_3"/></li>
		<li><img src="../data0/images/img_0654.jpg" alt="Xplore-2015" title="Xplore-2015" id="wows0_4"/></li>
		<li><img src="../data0/images/img_0985.jpg" alt="Electronics Project" title="Electronics Project" id="wows0_5"/></li>
		<li><img src="../data0/images/img_1319.jpg" alt="Principal  Dr.Wadia Inaugrating Xplore-2015 " title="Principal  Dr.Wadia Inaugrating Xplore-2015 " id="wows0_6"/></li>
		<li><a ><img src="../data0/images/img_1471.jpg" alt="jquery image gallery" title="Physics Project At Xplore-2015" id="wows0_7"/></a></li>
		<li><img src="../data0/images/img_1535.jpg" alt="Chemistry Department Project At Xplore-2015" title="Chemistry Department Project At Xplore-2015" id="wows0_8"/></li>
	</ul></div>
	<div class="ws_bullets"><div>
		<a href="#" title="Wilson Sir At Xplore 2015"><span><img src="../data0/tooltips/b.jpg" alt="Wilson Sir At Xplore 2015"/>1</span></a>
		<a href="#" title="Xplore 2015 Participants"><span><img src="../data0/tooltips/c.jpg" alt="Xplore 2015 Participants"/>2</span></a>
		<a href="#" title="Lightening Of Lamp By Wilson Sir At Xplore 2015"><span><img src="../data0/tooltips/d.jpg" alt="Lightening Of Lamp By Wilson Sir At Xplore 2015"/>3</span></a>
		<a href="#" title="Sunita Mam At Xplore-2015"><span><img src="../data0/tooltips/dsc_0020.jpg" alt="Sunita Mam At Xplore-2015"/>4</span></a>
		<a href="#" title="Xplore-2015"><span><img src="../data0/tooltips/img_0654.jpg" alt="Xplore-2015"/>5</span></a>
		<a href="#" title="Electronics Project"><span><img src="../data0/tooltips/img_0985.jpg" alt="Electronics Project"/>6</span></a>
		<a href="#" title="Principal  Dr.Wadia Inaugrating Xplore-2015 "><span><img src="../data0/tooltips/img_1319.jpg" alt="Principal  Dr.Wadia Inaugrating Xplore-2015 "/>7</span></a>
		<a href="#" title="Physics Project At Xplore-2015"><span><img src="../data0/tooltips/img_1471.jpg" alt="Physics Project At Xplore-2015"/>8</span></a>
		<a href="#" title="Chemistry Department Project At Xplore-2015"><span><img src="../data0/tooltips/img_1535.jpg" alt="Chemistry Department Project At Xplore-2015"/>9</span></a>
	</div></div><div class="ws_script" style="position:absolute;left:-99%"><a >bootstrap slider</a> by WOWSlider.com v8.2</div>
	<div class="ws_shadow"></div>
	</div>	
	<script type="text/javascript" src="../engine0/wowslider.js"></script>
	<script type="text/javascript" src="../engine0/script.js"></script>
	<!-- End WOWSlider.com BODY section --><img src="college.jpg"></center>
