            ...
            <div id="page-inner" style="min-height:600px!important">
                <div class="row">
                    <div class="col-md-12"><br>
                        <h2 class="page-head-line" align="center">Switch Details Updation</h2>
                    </div>
                </div>
                <div class="row">
        <form name="tstest" method="post" action="dbupdatesw.php">
<?php
...
if($id=="All")
{
	  ...
	  $sql="select * from jhc_switch";

}

else{ $sql="select * from jhc_switch WHERE IdNo='$id'";}
...
<tr>
	  	<th>Id</th>
	    <td>
	    <input type = "text" name = "Id" disabled style="width: 200px;" value = "<?php echo $row['IdNo']; ?>" >
    </td>
<th>
&nbsp;&nbsp;&nbsp;&nbsp;Location	    </th>
	    <td>
...
<tr>
	    ...
	    <td> <input type="Text" class="form-control" name="mod" style="width: 200px;" value = "<?php echo $row['ModelType']; ?>" >
</td>
...
<td>
<input type="Text" class="form-control" style="width: 200px;" name = "ser" value="<?php echo $row['SerialNo']; ?>" >
</td>   
	</tr>
<tr>
