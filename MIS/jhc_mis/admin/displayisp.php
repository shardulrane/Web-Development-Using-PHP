...
<tr>
	    ...
	    <td>
	    <input type = "text" name = "id" class="form-control" readonly class="form-control" value = "<?php echo $row['Id']; ?>" >
    </th>	    
	  	<td>&nbsp;&nbsp;&nbsp;&nbsp;<label>
	   ISP Name</label>
	    </th>
	    <td>
	    <input type = "text" class="form-control" name = "ispname" readonly value = "<?php echo $row['ISP_Name']; ?>" >
	    </td>
	    ...
	    <td>
	    <input type = "text" class="form-control" name = "callog" readonly value = "<?php echo $row['Down_Tim']; ?>" >
	    </td>
	   	  	<th>&nbsp;&nbsp;&nbsp;&nbsp;<label>
Start Time</label>
	    </th>
	    <td> <input type="Text" class="form-control" id="timestamp" name="timestamp" style="width: 200px;" >
