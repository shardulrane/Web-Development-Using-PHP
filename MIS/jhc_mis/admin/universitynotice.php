...
?>                         
 ...
 <li>
            ...
            <div id="page-inner" style="min-height:600px!important">
                <div class="row">
                    <div class="col-md-12"><br>
                        <h2 class="page-head-line"><center>University E-Notices</h1></center>
                    </div>
                </div>
	...
	$result_set=mysql_query($sql);
			...
			?>
				<tr>
				<td align='center'><a href="../Uploads/<?php echo $row['file'] ?>" target="_blank"><?php echo $row['Title'] ?>
				</a></td>
				</tr>
        <?php
			}
		...
		?>	
				...
				<td align='center'><a href="../Uploads/<?php echo $row['file'] ?>" target="_blank"><?php echo $row['Title'] ?></a></td>
				</tr>
				 <?php
	}
			}
