...
xmlhttp.open("GET","getamc.php?q="+str,true);
xmlhttp.send();
}
...
xmlhttp.open("GET","getamc1.php?q="+str,true);
xmlhttp.send();
}
...
?>                           
	...
	<li>
            ...
            <div id="page-inner" style="min-height:600px!important">
                <div class="row">
                    <div class="col-md-12"><br>
                        <h2 class="page-head-line" align="center">Filter AMC Call Log Details</h2>
                    </div>
                </div>
                <div class="row">
		...
		<td><select name="dept" onchange="showUser0(this.value)" class="btn btn-default dropdown-toggle">
...
<td><select name="stat" onchange="showUser1(this.value)" class="form-control">
...
<td><input type="text" id="t1" name="inputField" style="width: 150px;" onclick='scwShow(this,this);' class="btn btn-default dropdown-toggle"/>
<input type="button" value="Submit" style="width: 70px; height: 30px" onclick = "showUser2('getamc2.php', 'txtHint')" class="btn btn-primary"></td>
</tr>
<tr>
<th colspan="6"><label>Select Date Range</label></th>
</tr>
<tr>
...
<th><h4>To Date</h4></th>
<td colspan="2"><input type="Text" id='t2' name="timestamp0" style="width: 150px;" onclick='scwShow(this,this);' class="btn btn-default dropdown-toggle"></td>
<td><input type = "button" value = "Click" onclick = "getData('amcdt.php', 'txtHint')" class="btn btn-primary"></td>
</tr>
</table>
</form>
