	...
	<li>
            ...
            <div id="page-inner" style="min-height:600px!important">
                ...
                <div class="row">
				   ...
				   <td colspan="3"><select name="dept" onchange="showUser0(this.value)" class="form-control" >
...
<td><select name="users"  onchange="showUser(this.value)" class="form-control">
...
<td><select name="users" class="form-control" onchange="showUser1(this.value)" >
