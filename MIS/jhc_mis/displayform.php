...
//echo $sql;
	...
	$row=mysql_fetch_array($result);
	  ...
	  <tr>
	  <th>ID</th>
	  <td><input type = "text" name = "Id" disabled style="width: 200px;" class="form-control" value = "<?php echo $row['Id']; ?>" ></td>
	  <th>&nbsp;&nbsp;&nbsp;&nbsp;	   Name
	    </th>
	    <td>
	    <input type = "text" name = "username"  style="width: 200px;" class="form-control" value = "<?php echo $row['Username']; ?>" >
	    </td>
...
Catgory	    </th>
	    <td>
	    <input type = "text" name = "cat"  style="width: 200px;" class="form-control" value = "<?php echo $row['Catgory']; ?>" >
	    </td>
	    ...
	    <input type = "text" name = "timestamp0" style="width: 200px;" class="form-control" value = "<?php echo date('d-m-Y H:i:s',strtotime($row['Call_log_DateTim'])); ?>" >
...
Engineer
	    ...
	    <td>
	    <input type = "text" name = "eng" class="form-control" style="width: 200px;" value = "<?php echo $row['Enginner']; ?>" >
	    </td>
</tr>
<tr>
<th>
Response log Date & Time
	    </th>
...
<tr><td></td>
	    <th>&nbsp;&nbsp;&nbsp;&nbsp;
	    <input type = "Submit" class="btn btn-primary" name = "update" value = "Update" onclick="return ProcessForm()" style="width: 100px; height: 30px">
    </td><td></td>       </tr>
