            ...
            <div id="page-inner"  style="min-height:600px!important">
                <div class="row">
                    <div class="col-md-12"><br>
                        <h2 class="page-head-line"><center>Desktop &Laptop Entry</center></h2>
                    </div>
                </div>
                <div class="row">
				<form name="tstest" method="post" action="deskinput.php">
...
<td>
 <label>JHC Asset Verification Number</label></td>
 <td>
 <input type="Text" name="asset" class="form-control"></td>
</tr>
<tr>
 <td><label>Item</label></td><td>
 <input type="Text" name="item" class="form-control"></td><td>
...
<td>
 ...
 <input type="Text" name="ser" class="form-control"></td><td>
 <label>CPU</label></td><td>
 <input type="Text" name="cpu" class="form-control"></td></tr>
<tr>
 <td>
 <label>MHZ</label></td><td>
 <input type="Text" name="mhz" class="form-control"></td><td>
 <label>RAM</label></td><td>
 <input type="Text" name="ram" class="form-control"></td>
</tr>
<tr>
<td>
 <label>HDD/Sr.No</label></td><td>
 <input type="Text" name="hdd" class="form-control"></td><td>
 <label>Optical</label></td><td>
 <input type="Text" name="op" class="form-control"></td>
</tr>
<tr>
<td>
 <label>Monitor</label></td><td>
 <input type="Text" name="mon" class="form-control"></td><td>
 <label>Serial No</label></td><td>
 <input type="Text" name="ser1" class="form-control"></td></tr>
<tr>
<td>
 <label>Keyboard Serial No</label></td><td>
 <input type="Text" name="key" class="form-control"></td><td>
 <label>Mouse Serial No</label></td><td>
 <input type="Text" name="mse" class="form-control"><br></td></tr>
 <tr><td colspan='4' align="center">
 <input type="submit" name="submit" value="Submit" onclick="return ProcessForm()" class="btn btn-primary">
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <input type="reset" name="reset" value="Reset" class="btn btn-primary"></td></tr>
 </table>
 </form>
