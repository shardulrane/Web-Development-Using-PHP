...
<tr>
	    ...
	    <td> <input type="Text" clas="form-control" name="mod" style="width: 200px;" value = "<?php echo $row['ModelType']; ?>" >
</td>
...
<td>
<input type="Text" class="form-control" name = "ser" value="<?php echo $row['SerialNo']; ?>" >
</td>   
	</tr>
<tr><td></td>
	    <td>&nbsp;&nbsp;&nbsp;&nbsp;
