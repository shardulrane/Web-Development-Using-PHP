...
function ProcessForm()
			{
				document.ReadID.id.disabled=false;
            ...
            <div id="page-inner" style="min-height:600px!important">
                <div class="row">
                    <div class="col-md-12"><br>
                        <h2 class="page-head-line" align="center">ISP Log Updation</h2>
                    </div>
                </div>
                <div class="row">
                <div class="col-md-6">                   
        <form name="tstest" method="post" action="ispdbupdate.php">
		<?php
...
mysql_select_db("mis", $con);
		...
		$id = $_REQUEST['id'];
	  $sql="select * from ispinfo_tab WHERE Id='$id'";
...
<tr>
	  	<th>Id</th>
	    <td width = "150">
	    <input type = "text" name = "id" class="form-control" disabled style="width: 200px;" value = "<?php echo $row['Id']; ?>" >
    </th>	    
	  	<td>&nbsp;&nbsp;&nbsp;&nbsp;
	   ISP Name
	    </th>
	    <td width = "150">
	    <input type = "text" class="form-control" name = "ispname" disabled style="width: 200px;" value = "<?php echo $row['ISP_Name']; ?>" >
	    </td>
	    ...
	    <td width = "150">
	    <input type = "text" class="form-control" name = "callog" style="width: 200px;" disabled value = "<?php echo $row['Down_Tim']; ?>" >
	    </td>
	   	  	<th>&nbsp;&nbsp;&nbsp;&nbsp;
Start Time
	    </th>
	    <td> <input type="Text" class="form-control" name="timestamp" style="width: 200px;" value = "" >
<a href="javascript:show_calendar('document.ReadID.timestamp', document.ReadID.timestamp.value);"><img src="cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the timestamp"></a></td>

	    </tr>
<tr><th>Status</th>
	   <td>
		 <input type = "text" class="form-control" name = "stat" style="width: 200px;" value = "<?php echo $row['Status']; ?>" ></td>
	    <th colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;<input type = "Submit" name = "update" value = "Update" onclick="return ProcessForm()" class="btn btn-primary" style="width: 100px; height: 30px">
    </td>    </tr>
	</table>
