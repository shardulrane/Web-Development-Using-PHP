...
</script>	<script language="JAVASCRIPT" src="scw.js">
</script>
...
xmlhttp.open("GET","getproj1.php?q="+str,true);
xmlhttp.send();
}
...
xmlhttp.open("GET","getproj.php?q="+str,true);
xmlhttp.send();
}
            ...
            <div id="page-inner" style="min-height:600px!important">
                <div class="row">
                    <div class="col-md-12"><br>
                        <h2 class="page-head-line"><center>Filter Projector Details</center></h2>
                    </div>
                </div>
                <div class="row">
...
$sql="SELECT distinct Department FROM jhc_projector  order by Department";
...
$sql="SELECT distinct Location FROM jhc_projector order by Location ";
